...
public class DaoImpl implements DAO<Long, Serializable>{
    ...
    public final Serializable get(final Long key) {
        ...
        try {
            ...
            out.writeObject(Integer.valueOf(DAO.GET));
            out.writeObject(Long.valueOf(key));
    ...
    public final void delete(final Long key) {
        try {
            ...
            // out.writeObject(new Long(key));
            out.writeObject(Integer.valueOf(DAO.DELETE));
            out.writeObject(Long.valueOf(key));
            out.flush();
        } catch (Exception e) {
            e.printStackTrace();
    ...
    public final void update(final Long key, final Serializable value) {
        try {
            ...
            // out.writeObject(new Long(key));
            out.writeObject(Integer.valueOf(DAO.UPDATE));
            out.writeObject(Long.valueOf(key));
            out.writeObject(value);
            out.flush();
        } catch (Exception e) {
    ...
    public final int size() {
        ...
        try {
            ...
            out.writeObject(Integer.valueOf(DAO.SIZE));
