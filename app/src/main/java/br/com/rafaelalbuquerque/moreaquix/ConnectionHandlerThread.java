...
public class ConnectionHandlerThread extends Thread implements DAO<Long, Serializable>{
     ...
     *
     * @param newSocket   the network connection where this handler will be
     *                    listening.
     * @param newDatabase the database of students.
     */
    public ConnectionHandlerThread(final Socket newSocket, final Map<Long, Serializable> newDatabase) {
     ...
     * @param value the value that is going to be inserted into the database.
     */
    public final void add(final Long key, final Serializable value) {
        System.out.println("New object received: " + value + ", Current size of the database: " + database.size());
     ...
     *
     * @param key the id of the object that is being looked up.
